...
public class ViewNewAccount {
	...
	*/
	...
	protected static Alert alertInvalidUserName = new Alert(AlertType.ERROR);
	...
	*/
	...
	private ViewNewAccount() {
		...
		alertInvalidUserName.setTitle("Invalid User Name");
		alertInvalidUserName.setHeaderText("The entered User Name is invalid.");
