...
public class ViewAdminHome {
    ...
    */
    ...
    // Replaced placeholder roles (Role1, Role2) with functional application roles (Contributor, Viewer)
    ...
    // Role numerical representation mapping
    ...
    */
    ...
    private ViewAdminHome() {
        ...
        setupComboBoxUI(combobox_SelectRole, "Dialog", 16, 120, 500, 205);
    
        // Populate invitation role ComboBox with updated functional roles (Admin, Contributor, Viewer)
