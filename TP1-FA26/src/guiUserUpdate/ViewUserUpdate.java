...
public class ViewUserUpdate {
    ...
    // Dialog box added to allow the user to input an updated password
    ...
    private ViewUserUpdate() {
        ...
        // Initialize the password input dialog
        ...
        // Set labels and title for the password dialog
        ...
        // Action event handler for the Update Password button
        ...
        button_UpdateEmailAddress.setOnAction((event) -> {result = dialogUpdateEmailAddresss.showAndWait();
            result.ifPresent(email -> theDatabase.updateEmailAddress(theUser.getUserName(), result.get()));
            theDatabase.getUserAccountDetails(theUser.getUserName());
